...
banchat.push(from)
replay('This Group has been banned from using me! Ask Ronen to unban this group')
 ...
 *Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
 ...
 case 'resetlinkgc':
    ...
    case 'group': case 'grup': {
     ...
     image: BotLogo,
     jpegThumbnail: Thumb,
     caption: `*「 ${global.BotName} 」*\n\nType *.group open* to open group or type *.group close* to close group:`,
     footer: `${BotName}`,
     buttons: buttons,
     headerType: 4
     }
...
case 'pinterest': case 'pin': {
 ...
 let buttons = [
 {buttonId: `.pinterest ${args.join(" ")}`, buttonText: {displayText: '➡️'}, type: 1}
 ]
 let buttonMessage = {
 image: { url: imgnyee },
...
What's going on between you two hehe👀💖...`
    ...
    if (isBanChat) return reply(mess.bangc)
         ...
         "breakup with your best friend for 5hrs without telling him/her that its a dare",
          ...
          "send abusive words in any grup, excepting this grup, and send screenshot proof here"
                   ...
                   buffer = await getBuffer(`https://wallpapercave.com/uwp/uwp2150035.jpeg`)
...
case 'truth':
    ...
    if (isBanChat) return reply(mess.bangc)
                 ...
                 "do you use Instagram?, if yes then send ur insta id"
             ]
